            ...
            <div class="card-body">
                <form action="../controller/actions_cadaster.php" method="post" class="form">
                    ...
                    <div class="form-group">
                        <input type="text" name="product" id="product" placeholder="Digite o nome do produto" class="form-control" required>
                    </div>

                    <br><br>

                    <div class="form-group">
                        <input type="text" name="productType" id="productType" placeholder="Produto salgado, doce ou perecível" class="form-control" required>
                    </div>

                    <br><br>                            

                    <div class="form-group">
                        <input type="text" name="productQuantity" id="productQuantity" placeholder="Quantidade de produtos comprados" class="form-control" required>
                    </div>
